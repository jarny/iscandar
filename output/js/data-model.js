...
define(function(require, exports, module) {
    module.exports = {
		metadata: {"name": "example", "description": "Describe the dataset here, giving a quick summary of what it is about. Could be the user supplied description when requesting a dataset in stemformatics. Only name is the compulsory field in this table.", "read mapping summary": "Describe how the reads are mapped, eg: Reads were aligned using subread package in R.", "QC notes": "Describe any notes about QC, eg: scater package from R was used to filter out outlier samples."},	// {'name':'pera', ...}
		...
		analysisMetadata: {"PCA_function": "Describe some details of the function used, including references. eg: (python) <a href='http://scikit-learn.org/stable/modules/generated/sklearn.decomposition.PCA.html'>sklearn PCA</a>", "TSNE_function": "Same as PCA_function. eg: (R) <a href='https://cran.r-project.org/web/packages/Rtsne/index.html'>Rtsne</a>", "TSNE_parameters": "Describe some details of the parameters used for TSNE. eg: perplexity=20 (roughly the number of neighbours for each point),<br/> n_iter=1000 (number of iterations),<br/> ", "Notes": "Other general notes useful for the user. eg: log2(cpm+1) was used before performing PCA and TSNE, where cpm is the counts per million expression matrix.", "gene sets": "Describe where the gene sets included come from. eg: These gene sets are DE genes between WT vs Mut.", "genes included": "Describe which genes have been included in this report for showing expression."},	// {'Notes': 'log2(cpm+1) was used',...}
		...
		clusterColours: {"cell_cycle": {"G1": "#1b9e77", "G2M": "#d95f02", "S": "#7570b3"}},	// {'tsne p=20':{'cluster01':'#efefef',...},...}
		...
		geneExpressionValues: {"gene1": [4.7090890754506205, 5.02020142226141, 2.7607814581582497, 4.35385260623762], "gene2": [1.76376951420201, 2.76418653711792, 4.1963629662962205, 0.8840457486405731], "gene3": [0.6771343944640239, 0.0, 2.926570464097129, 0.0]},	// {'gene1':[0, 2.31, ...], ...}
    };
});
